        ...
        <>
            ...
            <section className="relative my-6 w-full text-center">
                ...
                <div className="prose m-auto px-6 text-center dark:prose-dark">
                    <span>In every job I undertake, I consistently strive to automate repetitive tasks. I have a passion for DevOps, but I often find myself transitioning into a full-stack developer role as well. Over the years, I've become a generalist in software technology and plan to expand my expertise to include hardware. I never take the lessons I've learned for granted and will always appreciate the knowledge I've gained throughout my career.</span>
                </div>
            </section>
